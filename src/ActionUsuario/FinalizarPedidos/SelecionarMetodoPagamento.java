...
//        Pagamento pagamentoInterface = null;

//        switch (TipoPagamento.fromCodigo(Integer.parseInt(pagamento))){
//            case DEBITO:
//                pagamentoInterface = new PagamentoDebito();
//                break;
//            case CREDITO:
//                pagamentoInterface = new PagamentoCredito();
//                break;
//            case "3":
//                pagamentoPix();
//                break;
...
//        }
        ...
        return TipoPagamento.fromCodigo(Integer.parseInt(pagamento)).getInstance().pagar();
    }
